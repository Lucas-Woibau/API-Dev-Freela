...
namespace DevFreela.UnitTests.Helpers
{
    public class FakeDataHelper
    {
        ...
        private static readonly Faker<InsertProjectCommand> _inserProjectCommandFaker = new Faker<InsertProjectCommand>()
            ...
            .RuleFor(c => c.TotalCost, f => f.Random.Int(1000, 10000));
        ...
        public static InsertProjectCommand CreateFakeInsertProjectCommand()
            => _inserProjectCommandFaker.Generate();
